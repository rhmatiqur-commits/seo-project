...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      seo_action_outcomes: {
        Row: {
          ...
          classification: Database["public"]["Enums"]["outcome_classification"]
          ...
          organization_id: string
          page_lifecycle_stage:
            | Database["public"]["Enums"]["page_lifecycle_stage"]
            | null
          recommendation: Database["public"]["Enums"]["outcome_recommendation"]
          seo_action_id: string
          updated_at: string
          website_id: string
          window_end: string
          window_start: string
        ...
        Relationships: [
          {
            foreignKeyName: "seo_action_outcomes_follow_up_task_id_fkey"
          ...
          {
            foreignKeyName: "seo_action_outcomes_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_action_outcomes_seo_action_id_fkey"
          ...
          {
            foreignKeyName: "seo_action_outcomes_website_id_fkey"
            columns: ["website_id"]
            isOneToOne: false
            referencedRelation: "websites"
            referencedColumns: ["id"]
      ...
      seo_actions: {
        Row: {
          action_type: Database["public"]["Enums"]["seo_action_type"]
          ...
          seo_opportunity_id: string | null
          seo_task_id: string | null
          status: Database["public"]["Enums"]["seo_action_status"]
        ...
        Relationships: [
          {
            foreignKeyName: "seo_actions_content_brief_id_fkey"
            columns: ["content_brief_id"]
            isOneToOne: false
            referencedRelation: "content_briefs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_actions_content_publication_id_fkey"
            columns: ["content_publication_id"]
            isOneToOne: false
            referencedRelation: "content_publications"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_actions_content_version_id_fkey"
            columns: ["content_version_id"]
            isOneToOne: false
            referencedRelation: "content_versions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_actions_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_actions_seo_opportunity_id_fkey"
            columns: ["seo_opportunity_id"]
            isOneToOne: false
            referencedRelation: "seo_opportunities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_actions_seo_task_id_fkey"
            columns: ["seo_task_id"]
            isOneToOne: false
            referencedRelation: "seo_tasks"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_actions_target_keyword_id_fkey"
          ...
          {
            foreignKeyName: "seo_actions_website_id_fkey"
            columns: ["website_id"]
            isOneToOne: false
            referencedRelation: "websites"
            referencedColumns: ["id"]
      ...
      seo_alerts: {
        Row: {
          ...
          seo_action_outcome_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "seo_alerts_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_alerts_seo_action_id_fkey"
            columns: ["seo_action_id"]
            isOneToOne: false
            referencedRelation: "seo_actions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "seo_alerts_seo_action_outcome_id_fkey"
            columns: ["seo_action_outcome_id"]
            isOneToOne: false
            referencedRelation: "seo_action_outcomes"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "seo_alerts_website_id_fkey"
            columns: ["website_id"]
            isOneToOne: false
            referencedRelation: "websites"
            referencedColumns: ["id"]
      ...
      websites: {
        Row: {
          action_outcomes_frequency_days: number
    ...
    Enums: {
      ...
      seo_action_status: "PENDING" | "APPROVED" | "EXECUTED" | "CANCELLED"
      seo_action_type:
        | "CREATE_NEW_PAGE"
        | "OPTIMISE_EXISTING_PAGE"
        | "IMPROVE_CTR"
        ...
        | "COMPETITOR_RANKING_GAP"
        | "TECHNICAL_FIX"
      seo_alert_severity: "info" | "warning" | "critical"
      seo_alert_status: "open" | "acknowledged"
      seo_alert_type:
        | "RANKING_DECLINE"
        | "TRAFFIC_DECLINE"
...
export type SeoActionStatus = Database["public"]["Enums"]["seo_action_status"];
export type AutonomyLevel = Database["public"]["Enums"]["autonomy_level"];
export type OutcomeClassification = Database["public"]["Enums"]["outcome_classification"];
export type OutcomeRecommendation = Database["public"]["Enums"]["outcome_recommendation"];
export type PageLifecycleStage = Database["public"]["Enums"]["page_lifecycle_stage"];
